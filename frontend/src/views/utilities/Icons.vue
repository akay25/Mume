...
<template>
  <div class="card">
    <h2>Icons</h2>
    <p>
      PrimeVue components internally use <a href="https://github.com/primefaces/primeicons"
        class="font-medium text-primary hover:underline">PrimeIcons</a> library, the official icons suite from
...
&lt;i class="pi pi-times"&gt;&lt;/i&gt;</code></pre>
    ...
    <p>
      Here is the current list of PrimeIcons, more icons are added periodically. You may also <a
        href="https://github.com/primefaces/primeicons/issues" class="font-medium text-primary hover:underline">request
